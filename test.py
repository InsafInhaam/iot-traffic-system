...
def preprocess_image(image_path):
    ...
    _, binary = cv2.threshold(gray, 128, 255, cv2.THRESH_BINARY)  # convert to B/W
...
if __name__ == "__main__":
    ...
    for (x, y, w, h), center in zip(vehicles, centers):
        ...
        cv2.putText(image, f"Lane {lane_number}", (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0,0,255), 2)
